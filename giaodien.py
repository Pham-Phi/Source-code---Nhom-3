...
win.title("NHÓM 3 - HỆ THỐNG NHẬN DIỆN KHUÔN MẶT")

win.geometry('500x300')
win.configure(bg='#22E622')
label = ttk.Label(win,text="HỆ THỐNG NHẬN DIỆN KHUÔN MẶT",background="#22E622",foreground="blue",font=200)
label.grid(column =1, row =0)
label.place(x=130, y=20)


label1 = ttk.Label(win,text="ID:",background="#22E622",foreground="blue",font=100 )  
label1.grid(column =0, row =2)
label1.place(y=80)

label2 = ttk.Label(win,text="HỌ TÊN:",background="#22E622",foreground="blue",font=100)
...
btlaydulieu= ttk.Button(win, text ="NHẬP DỮ LIỆU", command=laydulieu, )
